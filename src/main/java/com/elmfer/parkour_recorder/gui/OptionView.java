...
public class OptionView extends Widget implements IMenuTabView
{
	...
	{
		return I18n.get("com.elmfer.loop",
				ConfigManager.isLoopMode()
						? I18n.get("com.elmfer.enabled")
						: I18n.get("com.elmfer.disabled")
		);
	...
	{
		return I18n.get("com.elmfer.hidden_ip",
	...
	{
		return I18n.get("com.elmfer.show_inputs",
	...
	public void draw()
	{
		...
		asideBody.pushMatrix(false);
		{
			...
			String subTitle = I18n.get("com.elmfer.options");
	...
	private static class CategoryHeading extends Widget
	{
		...
		public void draw()
		{
			...
			UIrender.drawString(Anchor.MID_LEFT, I18n.get(translationKey), x + 5, y + height / 2, 0xFFFFFFFF);
		}
