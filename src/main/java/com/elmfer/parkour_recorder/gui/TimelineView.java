...
public class TimelineView extends Widget implements IMenuTabView
{
	...
	public void onExit()
	{
		...
		if (viewer != null)
		{
			mc.world.removeEntityDangerously(viewer);
			mc.renderGlobal.loadRenderers();
		}
	...
	private void renderCheckpointStatus(Viewport taskBar)
	{
		if (currentCheckpoint != null)
		{
			...
			{
				GlStateManager.translate(0, taskBar.getHeight(), 0);
		...
		public void draw()
		{
			if (isVisible())
			{
				...
				GlStateManager.pushMatrix();
				{
					...
					GlStateManager.rotate((float) gear.getProperty("rotation").getValue(), 0.0f, 0.0f, 1.0f);
	...
	public void onKeyPressed(int keyCode)
	{
		...
		{
			if (keyCode == Keyboard.KEY_SPACE || keyCode == Keyboard.KEY_K)
			{
