    ...
    LINEAR(new Function<Double, Double>() {
        ...
        public Double apply(Double t) {
            ...
            if (t <= 0.5) {
                ...
                return Math.sin(9.0 * (t - (13.0 / 18.0)) * Math.PI) * 8.0 * Math.pow(t, 4.0)
                        + 512.0 * Math.pow(t, 10.0);
            } else {

                return Math.sin(9.0 * (t - (7.0 - 18.0)) * Math.PI) * -8.0 * Math.pow(t - 1.0, 4.0)
                        - 512.0 * Math.pow(t - 1.0, 10.0) + 1.0;
            }
        }
