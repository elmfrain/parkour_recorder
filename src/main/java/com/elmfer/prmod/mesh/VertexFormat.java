...
public final class VertexFormat
{
	...
	static
	{
		...
		POS_UV.addAttrib(AttribUsage.POSITION, AttribType.FLOAT, 3)
		.addAttrib(AttribUsage.UV, AttribType.FLOAT, 2);
		
		POS_COLOR.addAttrib(AttribUsage.POSITION, AttribType.FLOAT, 3)
		.addAttrib(AttribUsage.COLOR, AttribType.UNSIGNED_BYTE, 4, true);
		
		POS_UV_COLOR.addAttrib(AttribUsage.POSITION, AttribType.FLOAT, 3)
		.addAttrib(AttribUsage.UV, AttribType.FLOAT, 2)
		.addAttrib(AttribUsage.COLOR, AttribType.UNSIGNED_BYTE, 4, true);
