...
public class ButtonListView extends Widget {
    ...
    public void draw() {
        ...
        viewport.pushMatrix(true);
        {
            ...
            int tabTravel = (int) (((float) -scrollPosition.getValue() / scrollMovement)
                    * (viewport.getHeight() - tabHeight));
            ...
            UIRender.drawRect(viewport.getWidth() - scrollerWidth, tabTravel, viewport.getWidth(),
                    tabHeight + tabTravel, GraphicsHelper.getIntColor(0.4f, 0.4f, 0.4f, 0.3f));
        }
        viewport.popMatrix();
    }
