...
public class SaveRecordingView extends Widget implements IMenuTabView
{
	...
	public SaveRecordingView()
	{
		...
		{
			String title = 1 < selections.size() ? I18n.translate("com.prmod.remove_selected_?") : I18n.translate("com.prmod.should_remove_?");
	...
	@Override
	 public void draw()
	 {
		...
		aside.pushMatrix(false);
		{
			...
			if(selections.size() > 1) removeButton.setText(I18n.translate("com.prmod.remove_selected"));
			else removeButton.setText(I18n.translate("com.prmod.remove"));
		}
		aside.popMatrix();
	...
	private void onSave(Button button)
	{
		...
		if(selections.lastElement().getOriginalFile() != null)
		{
			...
			SaveToNew saveNewCallback = () ->
			{
				...
				{
					return new NamingWindow(I18n.translate("com.prmod.name_recording"), (String s) -> { return s.length() > 0; } , this::save);
				});
			...
			{
				return new OverrideWindow(I18n.translate("com.prmod.override_recording_?"), boxMessage, this::override, saveNewCallback);
			});
		}
		else
		{
