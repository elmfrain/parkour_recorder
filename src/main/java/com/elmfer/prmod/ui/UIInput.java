...
public class UIInput
{
	...
	/** The previous input callbacks are chained to the new ones to allow for multiple listeners.**/
	...
	private static GLFWMouseButtonCallback prevMouseButtonCallback = GLFW.glfwSetMouseButtonCallback(glfwWindow, UIInput::onMouseButton);
	private static GLFWScrollCallback prevScrollCallback = GLFW.glfwSetScrollCallback(glfwWindow, UIInput::onMouseScroll);
	...
	{
		return GLFW.glfwGetKey(glfwWindow, GLFW.GLFW_KEY_LEFT_CONTROL) == GLFW.GLFW_PRESS || GLFW.glfwGetKey(glfwWindow, GLFW.GLFW_KEY_RIGHT_CONTROL) == GLFW.GLFW_PRESS;
	}
	
	public static boolean isShiftPressed()
	{
		return GLFW.glfwGetKey(glfwWindow, GLFW.GLFW_KEY_LEFT_SHIFT) == GLFW.GLFW_PRESS || GLFW.glfwGetKey(glfwWindow, GLFW.GLFW_KEY_RIGHT_SHIFT) == GLFW.GLFW_PRESS;
	}
	
	public static boolean isAltPressed()
	{
		return GLFW.glfwGetKey(glfwWindow, GLFW.GLFW_KEY_LEFT_ALT) == GLFW.GLFW_PRESS || GLFW.glfwGetKey(glfwWindow, GLFW.GLFW_KEY_RIGHT_ALT) == GLFW.GLFW_PRESS;
	}
