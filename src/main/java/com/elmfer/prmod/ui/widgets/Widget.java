...
public abstract class Widget implements UIInput.Listener {
    ...
    private void updateHoverState(float cursorX, float cursorY) {
        ...
        hovered = (zLevel == currentZLevel) && (mX >= this.x && mY >= this.y && mX < this.x + this.width
                && mY < this.y + this.height && isHoverable);
    }
    ...
    private boolean cursorInViewport(float cursorX, float cursorY) {
        ...
        return cursorX >= viewportX && cursorY >= viewportY && cursorX < viewportX + viewportWidth
                && cursorY < viewportY + viewportHeight;
    }
    ...
    protected static class ModelviewAndViewportState {
        ...
        public void updateState() {
            ...
            RenderSystem.getModelViewMatrix().get(MODELVIEW_MATRIX);
