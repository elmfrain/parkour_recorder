...
import com.elmfer.prmod.ui.widgets.TextField;

import net.minecraft.client.resource.language.I18n;

public class NamingWindow extends Window {
    private final TextField textField = new TextField();
    private Button nameButton = new Button(I18n.translate("com.prmod.name"));
    ...
    public NamingWindow(String titleIn, Predicate<String> textPredicate, NamedCallback callback) {
        ...
        textField.setTitle(I18n.translate("com.prmod.type_here"));

        cancelButton.setAction((b) -> {
            setShouldClose(true);
        });
